...
df_tot = df_tot.drop(['Is_rebound','Players', 'Period', 'X', 'Y', 'Previous_x', 'Previous_y', 'Team', 'OppTeam',
                      'Shooter','Goalie', 'Empty_net'], axis=1).copy()

# Feature Shot_distance: Score: 471.0
# Feature Shot_angle: Score: 457.0
# Feature Previous_time_since: Score: 290.0
# Feature Goalie: Score: 222.0
# Feature Time_since_powp: Score: 186.0
# Feature Type_enc: Score: 157.0
# Feature Pe_enc: Score: 126.0
# Feature Rebound_angle: Score: 89.0
# Feature Speed: Score: 72.0
# Feature X_net: Score: 50.0
